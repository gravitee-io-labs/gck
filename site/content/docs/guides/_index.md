...
- **[CI/CD]({{< ref "/docs/guides/ci-cd" >}})** -- Integrate gck into CI pipelines with schema validation, image caching, and upgrade testing
- **[AI Toolchain]({{< ref "/docs/guides/ai-toolchain" >}})** -- How gck works with AI agents, and how to extend it for your product
